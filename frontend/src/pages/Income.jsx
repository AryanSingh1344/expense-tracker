      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <YAxis
            ...
            tick={{ fill: "#6b7280", fontSize: 12 }}
            width={50}
            tickFormatter={(value) => `₹${value.toLocaleString()}`} // Changed to ₹
          />
          <Tooltip
            formatter={(value) => [
              `₹${Math.round(value).toLocaleString()}`, // Changed to ₹
              "Income",
            ]}
...
const Income = () => {
  ...
  );//use backed overview if available
  ...
  //to update an income transaction
