...
const Login = ({ onLogin, API_URL = "https://expense-tracker-backend-ro7e.onrender.com" }) => {
    ...
    try {
      ...
      if (!profile && token) {
        try {
          ...
          console.warn("Could not fetch profile after login:", fetchError);
          profile = { email };
        }
      }
      ...
      if (typeof onLogin === "function") {
        try {
          ...
          console.warn("onLogin error:", callError);
          navigate("/");
        }
      } else {
        navigate("/");
